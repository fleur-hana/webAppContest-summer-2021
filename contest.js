...
/*****　制限時間エリア　*****/
  ...
  function startTimer(second) {
    ...
    checkTime = setInterval(chechkRemainingTime, 100);    //100ms毎に時間をチェック
  };
  /**
...
/**
 * 入力された回答と正解が一致するかチェックし、正解と不正解の処理を分岐させる関数を
 * enterキーが押された時に読み込む
 */
document.getElementById("input-answer").onchange = 
  function checkAnswer() {
    ...
    if (userAnswer === question.読み仮名) {
      ...
      startButton.disabled = false;　　　//終了したら挑戦ボタンがまた押せるようにする
    }
    else {
